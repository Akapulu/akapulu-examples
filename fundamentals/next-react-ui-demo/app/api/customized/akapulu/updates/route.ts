 ...
 *
 * Used by the customized `react-ui` demo. While `connecting`, the client polls this path with
 * `conversation_session_id` from the connect response so the prebuilt UI can show readiness progress.
 */
